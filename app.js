const coaches = [
  {
    id: '01', title: '研究方向與題目訂定', problem: '我不知道要研究什麼', accent: '#e95d3f',
    starters: [
  ...
  {
    id: '02', title: '前言思考', problem: '我不知道前言要怎麼想', accent: '#d8942c',
    starters: [
  ...
  {
    id: '03', title: '文獻閱讀與整合', problem: '我不知道文獻怎麼讀、怎麼整合', accent: '#90a83c',
    starters: [
  ...
  {
    id: '04', title: '研究方法', problem: '我不知道資料要怎麼蒐集', accent: '#3ca988',
    starters: [
  ...
  {
    id: '05', title: '資料分析', problem: '我不知道資料代表什麼', accent: '#338ca5',
    starters: [
  ...
  {
    id: '06', title: '結論反思', problem: '我不知道可以下什麼結論', accent: '#5578bb',
    starters: [
  ...
  {
    id: '07', title: '引註與學術倫理', problem: '我不知道哪些地方需要引用', accent: '#9069bb',
    starters: [
  ...
  {
    id: '08', title: 'APA / Citation Audit', problem: '我要檢查引註與參考文獻', accent: '#c05b87',
    starters: [
